      ...
      <div className="space-y-6 pb-10">
        ...
        {!isLoading && data?.lists.todaysAgenda && data.lists.todaysAgenda.length > 0 && (
           <motion.div 
             ...
             className="bg-gradient-to-r from-indigo-50 to-slate-100 dark:from-indigo-900/30 dark:to-slate-900/50 border border-indigo-200 dark:border-indigo-500/30 rounded-2xl p-5 backdrop-blur-md shadow-lg"
           >
