    ...
    <div className="min-h-screen relative overflow-x-hidden bg-[#0f172a]">
      ...
      >
        ...
        <GlassCard className="space-y-8 text-slate-300 leading-relaxed p-8 md:p-12">
          ...
          <section>
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-white">Execução de Contrato:</strong> Para fornecer o acesso ao sistema, gerenciar sua conta e prestar suporte.
                </div>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="text-emerald-400 shrink-0 mt-0.5" size={16} />
                <div>
                  <strong className="text-white">Cumprimento de Obrigação Legal:</strong> Para guarda de logs (Marco Civil) e emissão de notas fiscais.
                </div>
              </li>
              <li className="flex gap-3">
                <CheckCircle className="text-emerald-400 shrink-0 mt-0.5" size={16} />
                <div>
                  <strong className="text-white">Legítimo Interesse:</strong> Para segurança do sistema e prevenção a fraudes.
                </div>
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2 border-b border-white/10 pb-2">
              <span className="text-indigo-400">4.</span> Segurança da Informação
            </h2>
            <p className="mb-2">Adotamos medidas técnicas e organizacionais robustas para proteger seus dados, incluindo:</p>
            <ul className="grid md:grid-cols-2 gap-2 text-sm">
              <li className="flex items-center gap-2 bg-white/5 p-2 rounded-lg"><Lock size={14} className="text-emerald-400" /> Criptografia em trânsito (TLS 1.2+) e em repouso.</li>
              <li className="flex items-center gap-2 bg-white/5 p-2 rounded-lg"><Shield size={14} className="text-emerald-400" /> Autenticação de Dois Fatores (2FA) disponível.</li>
              ...
              <li className="flex items-center gap-2 bg-white/5 p-2 rounded-lg"><Server size={14} className="text-emerald-400" /> Backups diários.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2 border-b border-white/10 pb-2">
              <span className="text-indigo-400">5.</span> Seus Direitos (Art. 18 da LGPD)
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="border border-white/10 rounded-lg p-4 hover:bg-white/5 transition-colors">
                ...
                <span className="text-xs text-slate-400">Solicitar a retificação de dados incompletos.</span>
              </div>
              <div className="border border-white/10 rounded-lg p-4 hover:bg-white/5 transition-colors">
                <strong className="block text-white mb-1">Portabilidade</strong>
                <span className="text-xs text-slate-400">Exportar seus dados em formato aberto.</span>
              </div>
            </div>
          </section>
          ...
          <section className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-6 mt-8">
            ...
            <p className="mb-4 text-slate-300">
              Para exercer seus direitos ou esclarecer dúvidas, entre em contato com nosso Encarregado de Proteção de Dados:
            </p>
